...
/** 六档字号的具体取值；深浅两套主题共用，字色由各自的主题在调用处贴合。 */
val BurpRemoteTypographyTokens =
    BurpRemoteTypography(
        ...
        title = TextStyle(fontSize = 20.sp, lineHeight = 26.sp, fontWeight = FontWeight.Medium),
        subtitle = TextStyle(fontSize = 15.sp, lineHeight = 20.sp, fontWeight = FontWeight.Medium),
        ...
        technical = TextStyle(fontFamily = FontFamily.Monospace, fontSize = 13.sp, lineHeight = 20.sp),
    )
